...
var _ = Describe("Quality Benchmark", Label("quality"), Ordered, func() {
	...
	AfterAll(func() {
		...
		utils.DeleteInferenceService(envs.WorkloadNamespace, settings.InferenceServiceName+"-prefill")
		utils.DeleteInferenceService(envs.WorkloadNamespace, settings.InferenceServiceName+"-decode")
