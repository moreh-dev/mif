...
> Skills under `.agents/skills/` (e.g., `release`) are not part of this plugin package. They are discovered automatically via `AGENTS.md` when working inside the MIF repository.
