...
| :--------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `dataLayer`            | Activates the DataLayer subsystem. Required for the `data:` section to have any effect and for the `models` / `model-server-protocol-models` plugins to run. |
