---
sidebar_position: 1
sidebar_label: Heimdall Scheduler
...
| `pd-profile-handler`     | Uses the `prefill` and `decode` scheduling profile to select both prefill-only and decode-only pods. | [Prefill-decode disaggregation](/features/prefill-decode-disaggregation.mdx) |

#### Filter

| Plugin           | Description                                                                      | Reference                                                                   |
| ---------------- | -------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| `decode-filter`  | Selects only decode-only pods, and is used by the `decode` scheduling profile.   | [Prefill-decode disaggregation](/features/prefill-decode-disaggregation.mdx) |
| `prefill-filter` | Selects only prefill-only pods, and is used by the `prefill` scheduling profile. | [Prefill-decode disaggregation](/features/prefill-decode-disaggregation.mdx) |

#### Scorer

| Plugin                        | Description                                                                                                         | Reference                                                             |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `active-request-scorer`       | Scores based on the number of active requests.                                                                      | [Load-aware routing](/features/load-aware-routing.mdx)                 |
| `load-aware-scorer`           | Scores based on the number of queued requests.                                                                      | [Load-aware routing](/features/load-aware-routing.mdx)                 |
| `no-hit-lru-scorer`           | Scores based on whether the request hits the prefix cache, and if it misses, when each pod last experienced a miss. | [Load-aware routing](/features/load-aware-routing.mdx)                 |
| `precise-prefix-cache-scorer` | Scores based on the prefix cache hit rate.                                                                          | [Prefix cache-aware routing](/features/prefix-cache-aware-routing.mdx) |
| `queue-scorer`                | Scores based on the number of queued requests.                                                                      | [Load-aware routing](/features/load-aware-routing.mdx)                 |
| `session-affinity-scorer`     | Scores based on whether the pod has previously handled a request from the same session.                             | [Load-aware routing](/features/load-aware-routing.mdx)                 |
