...
This installs the `InferenceService` and `InferenceServiceTemplate` (Odin), `AIGateway` (Heimdall), and `SchedulingProfile` and `InferenceWorker` (Heimdall AIGateway) custom resource definitions.
