...
```yaml title="moai-inference-framework-values.yaml" {4-5,10,21,24}
...
minio:
  ...
  rootPassword: "minio123!" # Optional: override the default passwords.
  users:
    - accessKey: loki
      secretKey: "loki123!" # Optional: override the default passwords.
      policy: loki
