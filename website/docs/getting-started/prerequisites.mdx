...
The Heimdall and Odin charts installed below are pinned to the following released versions from the `moreh` Helm repository. The `helm upgrade` commands in the sections that follow use these same versions. (`moai-inference-framework` is pinned directly in its own install command.)

### Heimdall

{/* AUTO-GENERATED:heimdall-install-versions START */}
| Chart | Version | App version |
| --- | --- | --- |
| `heimdall` | `v0.5.0` | `v0.5.0` |
| `heimdall-aigateway-crd` | `v0.10.0` | `v0.10.0` |
| `heimdall-crd` | `v0.5.0` | `v0.5.0` |
{/* AUTO-GENERATED:heimdall-install-versions END */}

### Odin

{/* AUTO-GENERATED:odin-install-versions START */}
| Chart | Version | App version |
| --- | --- | --- |
| `odin` | `v0.12.0` | `v0.12.0` |
| `odin-crd` | `v0.12.0` | `v0.12.0` |
{/* AUTO-GENERATED:odin-install-versions END */}
