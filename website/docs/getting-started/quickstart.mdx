...
:::info
A SchedulingProfile is optional. If you do not create one, the gateway uses a built-in default profile. See the [SchedulingProfile reference](../reference/heimdall/usage.mdx) for its schema and the [Plugins catalog](../reference/heimdall/plugins.mdx) for the available scorers and pickers.
:::
