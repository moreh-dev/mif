...
:::info
A SchedulingProfile is optional. If you do not create one, the gateway uses a built-in default profile. See the [SchedulingProfile reference](../reference/heimdall/usage.mdx) for the full list of scorers, pickers, and the default profile composition.
:::
