...
In offline environments, also include the appropriate offline hub template (e.g., `vllm-dp-hf-hub-offline` for DP setups or `vllm-hf-hub-offline` for non-DP) in your `templateRefs`.
:::
