...
| nfd.worker.tolerations | list | `[{"key": "amd.com/gpu", "operator": "Exists", "effect": "NoSchedule"}, {"key": "nvidia.com/gpu", "operator": "Exists", "effect": "NoSchedule"}]` | Tolerations for NFD workers to run on GPU-enabled nodes. |
