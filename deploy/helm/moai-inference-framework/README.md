...
| redis-operator.enabled | bool | `true` | Enable OT-CONTAINER-KIT/redis-operator. Manages Redis Sentinel/Replication/Cluster CRs used by heimdall-inference-scheduler. Set to false if already deployed. |
